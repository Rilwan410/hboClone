      ...
      <div className="create-user h-screen flex justify-between items-center flex-col">
        ...
        <div className="create-user__form flex justify-center items-center">
          ...
          <div className="create-user__input-group flex flex-col jusitfy-center">
            ...
            <input type="text" className="create-user__inputText outline-none border-b-[1px] border-b-[rgb(132,0,255)] bg-transparent w-[300px] py-[10px] mb-8 text-2xl" />
            <div className="create-user__colors flex justify-between ">
              <div
                className="create-user__color create-user__color--active rounded-[50%] w-[30px] h-[30px] cursor-pointer transition-transform duration-500 ease-in-out hover:scale-125"
                style={{
                  background:
                    "linear-gradient(312deg, rgba(26,39,103) 0%, rgba(48, 20, 94, 1)45%, rgba(0,0,0,1) 100%);",
                }}
              />
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(167,195,34,1) 22%, rgba(15,181,174,1) 71%);",
                }}
              />
              <div
                className="create-user__color  rounded-[50%] w-[30px] h-[30px] cursor-pointer transition-transform duration-500 ease-in-out hover:scale-125"
                style={{
                  background:
                    "linear-gradient(135deg, rgba(195,139,34,1) 2%, rgba(15,33,181,1) 71%);",
                }}
              />
              <div
                className="create-user__color  rounded-[50%] w-[30px] h-[30px] cursor-pointer transition-transform duration-500 ease-in-out hover:scale-125"
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(55,34,195,1) 27%, rgba(181,15,74,1) 71%)",
                }}
              />
            </div>
          </div>
